<template>
  <div style="height:100%; position: relative">
    <v-toolbar class="ss-toolbar" height="52px">
      <v-btn icon to="/add-address" nuxt exact>
        <v-icon>mdi-arrow-left</v-icon>
      </v-btn>
      <v-toolbar-title class="m-fs-t">Locate</v-toolbar-title>
    </v-toolbar>
...
export default {
  ...
  validate({ store, redirect }) {
    if (store.state.addressForm.sessionToken && store.state.addressForm.placeId)
      return true;
